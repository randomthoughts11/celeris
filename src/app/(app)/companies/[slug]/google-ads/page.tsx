  ...
  return (
    <div className="space-y-8">
          ...
          >
            ...
            <div className="mt-4">
              <div className="mb-1 flex justify-between text-xs text-muted-foreground">
                ...
                <span>
                  {((campaign.budget - campaign.remaining_budget) / campaign.budget * 100).toFixed(0)}%
                </span>
              </div>
              <Progress
                value={
                  campaign.budget > 0
                    ? ((campaign.budget - campaign.remaining_budget) / campaign.budget) * 100
                    : 0
                }
                className="h-1.5"
              />
      ...
      {googleInsights.length > 0 && (
        <AiInsightsPanel insights={googleInsights} />
      )}
    </div>
  );
}
