...
export default async function MetaAdsPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className={cn("text-lg font-semibold", getHealthColor(campaign.health_score))}>
        ...
        {campaigns.length === 0 && (
          <Card className="border-white/5 bg-white/[0.02] p-12 text-center">
            <p className="text-muted-foreground">
              No Meta campaigns synced yet. Connect your Meta Ads account in
              settings.
            </p>
          </Card>
        )}
      ...
      {metaInsights.length > 0 && <AiInsightsPanel insights={metaInsights} />}
    </div>
  );
}
